var parkingLot = {
	...
	slots: [
		null,
		{ owner: 'Jake', color: 'red', locked: true},
		null,
		null,
		{ owner: 'Russel', color: 'skyblue', locked: true, time: new Date("2011-03-24")},
		{ owner: 'Amber', color: 'gold', locked: false, time: new Date("2013-09-19")},
		{ owner: 'Bob', color: 'blue', locked: true, time: new Date("2012-06-02")}, 
		{ owner: 'Jill', color: 'blue', locked: false, time: new Date("2013-06-02")},
		null,
		null
	] 
};
